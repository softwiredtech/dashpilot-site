/** Public source repositories, linked from the open-source section and footer. */
export const GITHUB_FIRMWARE = "https://github.com/softwiredtech/dashkit-firmware";
export const GITHUB_APP = "https://github.com/softwiredtech/dashpilot";
